...
#Load login info
DB_LOGIN_PATH = os.path.join(APP_FOLDER, 'private/db_login.json')
with open(DB_LOGIN_PATH) as db_login_f:
    DB_LOGIN = json.load(db_login_f)

#Log onto the database
commHolder = DBComm(**DB_LOGIN)
...
def createImage(checkpointID = None):
    #commHolder = DBComm('Yotam','','canvasDB',)
